#!/usr/bin/env bash
# Vast.ai on-start — ComfyBasicInstall: models → /workspace, ComfyUI on 8188 (no Trellis2/DINOv3).
set -euo pipefail
mkdir -p /workspace
echo "[$(date -Iseconds)] vast-onstart-comfyui-basic.sh starting" >> /workspace/onstart.log
